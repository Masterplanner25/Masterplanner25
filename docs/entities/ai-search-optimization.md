---
title: "AI Search Optimization (AISO)"
description: "Masterplan Infinite Weave knowledge base entry: AI Search Optimization (AISO). Part of the AI-native ecosystem founded by Shawn Knight."
